...
# ---------------- IMAGE ANALYSIS ----------------
# Called from /image-report once the photo is on Cloudinary, so the report form
# opens already filled in for someone who cannot type it.
#
# Takes the Cloudinary URL rather than the file: the photo has to reach
# Cloudinary regardless (issue.photo stores that URL), so posting the bytes here
# too would upload the same picture twice.
